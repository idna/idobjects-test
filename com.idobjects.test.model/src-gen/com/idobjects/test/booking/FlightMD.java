...
public final class FlightMD extends IdObjectMD{
    ...
    public static final IdObjectReferenceMD PASSENGERS = new IdObjectReferenceMD( FlightMD.class, PassengerMD.class, "passengers", "flights", true, ReferenceType.LIST, null );
